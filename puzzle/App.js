...
import { Image, Platform, SafeAreaView, StatusBar,
         StyleSheet, UIManager } from 'react-native';
        ...
        return (
            <LinearGradient style={styles.background} colors={BACKGROUND_COLORS}>
                ...
                <SafeAreaView style={styles.container}>
                    {!puzzle && (
                        <Start size={size} onStartGame={this.handleStartGame} onChangeSize={this.handleChangeSize} />
                    )}
                    {puzzle && (
                        <Game puzzle={puzzle} image={image} onChange={this.handleGameChange} onQuit={this.handleQuit} />
                    )}
                </SafeAreaView>
            </LinearGradient>
        )
